...
def get_answer_input():
    '''This function gets the users guess and asks for the users guess again if it does not meet the condition.'''
...
def run_game():
    ...
    while not correct and turns < 12:
        ...
        correct_digits_and_position = show_results(correct_digits_and_position, correct_digits_only)
        turns += 1
